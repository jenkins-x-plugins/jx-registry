...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-registry/main/8'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-registry:0.1.17'
